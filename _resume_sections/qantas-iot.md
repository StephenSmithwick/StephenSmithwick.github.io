...
*   Architected a high-concurrency middleware layer using Java and Spring to unify fragmented legacy APIs into RESTful Swagger APIs, supporting millions of flight events daily.
