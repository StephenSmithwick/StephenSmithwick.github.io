...
* *Architected a platform-wide certificate discovery and automation system*, managing 10k+ certificates across AWS, GCP, and Azure to eliminate renewal blind spots and *preventing expired certificate outages*.
...
* *Coordinated cross-functional remediation of a critical authentication vulnerability*, closing a security bypass vector involving inter-service communication between Envoy and application layers.
