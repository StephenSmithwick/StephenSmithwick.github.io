...
*   Architected a high-concurrency middleware layer using Java and Spring to unify fragmented legacy APIs, supporting millions of flight events daily (High-Volume Message Processing).
